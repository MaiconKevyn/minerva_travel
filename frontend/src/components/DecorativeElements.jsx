...
export const Airplane = ({ className = "w-12 h-12 text-secondary", style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M85 30C88 27 88 23 85 20C82 17 78 17 75 20L45 50L65 55L95 25Z" fill="white" opacity="0.3" />
  </svg>
);
...
export const Suitcase = ({ className = "w-12 h-12 text-accent", style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="25" y="45" width="50" height="30" rx="5" fill="white" opacity="0.2" />
    <line x1="35" y1="35" x2="35" y2="85" stroke="white" strokeWidth="4" opacity="0.4" />
    <line x1="65" y1="35" x2="65" y2="85" stroke="white" strokeWidth="4" opacity="0.4" />
  </svg>
);
