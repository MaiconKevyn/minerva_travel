...
| Worker | Pode usar providers placeholder e storage local | Mesmo banco/storage da API de staging | Mesmo banco/storage da API; embutido no web service quando usa o mesmo disco, ou processo independente com storage compartilhado |
